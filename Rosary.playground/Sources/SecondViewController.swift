...
public class SecondViewController: UIViewController {
    ...
    public override func loadView(){
        ...
        //dedeTalking.textAlignment = NSTextAlignment.center
    ...
    @objc func nextButton() {
        ...
        if count == 2{
            ...
            dedeTalking.frame = CGRect(x: 70, y: 50, width: 600, height: 300)
            dedeTalking.text = "On the large bead, meditate on the first mystery of the day and pray the Our Father:\n\nYou pray mysteries for each of the five sections (decades) of the rosary according to the day of the week, every day has 5 mysteries"
            next1.isHidden = false
        } else if count == 7{
            dedeTalking.frame = CGRect(x: 70, y: 50, width: 600, height: 300)
